...
KERNEL_TOTAL_SECTORS equ 256       ; 128KB total
KERNEL_CHUNK_SECTORS equ 64        ; 32KB per BIOS call (avoids 127 limit & segment wrap)
...
_start:
    ...
    ; Load the kernel in 4 chunks of 64 sectors (32KB each)
...
.read_loop:
    ...
    add dword [kernel_dap + 8], KERNEL_CHUNK_SECTORS
    adc dword [kernel_dap + 12], 0

    ; Advance destination segment by 0x0800 (32KB)
    add word [kernel_dap + 6], 0x0800

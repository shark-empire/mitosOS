...
// Note: Idiomatic Rust uses `&[String]` instead of `&Vec<String>` for read-only slice passing.
fn run_command(uart: &mut Uart, line: &str, history: &[String]) {
    ...
    match cmd {
        ...
        "about" => {
            // Evaluated at compile time for cleaner branching

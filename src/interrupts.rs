...
// Preserves scratch registers volatile across standard System V C calling conventions.
// The CPU automatically pushes SS, RSP, RFLAGS, CS, and RIP (40 bytes total).
// Pushing exactly 9 additional QWORD registers adds 72 bytes. 
// Total frame size is 112 bytes, perfectly preserving the 16-byte alignment rule.
#[cfg(target_arch = "x86_64")]
